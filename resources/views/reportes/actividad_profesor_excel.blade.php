  ...
  <table>
   ...
   <tr>                   
      ...
      <tr>
            ...
            <td width="10" style="font-size:11px; text-align: center;"><h4>N. plaza</h4></td>
          ...
          <td style="text-align: center;">{{$act->hora_salida}}</td>
           @foreach($docentes as $doc)
            @if($doc->n_plaza==$act->n_plaza)
               <td style="text-align: center;">{{$doc->nombre}} {{$doc->apellidos}}</td>
               <td style="text-align: center;">{{$doc->n_plaza}}</td>
               @break
            @endif
          @endForeach
           <td style="text-align: center;">{{$act->carrera}}</td>
