...
<div class="col-md-12">
              <div class="box">
                <div class="box-body">
                  ...
                  <tr style="border:0px; margin-bottom: 6px;">                   
                    <td colspan="3">
                     <h5><div style="text-align: center; margin-top: -20px; margin-bottom: 0px; background-color: rgb(166,166,166);"><b>REPORTE DE EQUIPOS<!--BITÁCORA DE ACCESO AL LABORATORIO DE CÓMPUTO SALA B--><br> 
                  ...
                  <tr>
                      ...
                      <th style="width: 150px; background-color: rgba(120,120,120,0.9); text-align: center; font-size:13px">Laboratorio</th>
                  </tr>
                  </thead>
                  <tbody>
    ...
    <tr>
          <th style="font-size: 11px; text-align: center; border-style: solid; border-color: #000000 #000000;">{{$equipo->nombre}}</th>
          <th style="font-size: 11pxpx; text-align: left; border-style: solid; border-color: #000000 #000000;">Descripcion: {{$equipo->descripcion}}<br>
          ...
          @foreach($laboratorios as $lab)
            @if($equipo->id_laboratorio==$lab->id)
                <th style="font-size: 11px; text-align: center; border-style: solid; border-color: #000000 #000000;">{{$lab->nombre}} </th>
            @endif
          @endForeach
