                ...
                <div class="box-body">
                  ...
                  <tr><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td></tr>
                   <tr style="border-color: white;">
                    ...
                    <td colspan="5" style="width: 180px; text-align:center; border-color: white;">
                  ...
                  <tr>
                      ...
                      <th style="width: 30px; background-color: rgba(120,120,120,0.9); font-size:13px; border-style: solid; border-color: #000000 #000000;">Hora Entrada</th>
                      <th style="width: 30px; background-color: rgba(120,120,120,0.9); text-align: center; font-size:13px; border-style: solid; border-color: #000000 #000000;">Hora Salida</th>
                      <th style="width: 190px; background-color: rgba(120,120,120,0.9); text-align: center; font-size:13px; border-style: solid; border-color: #000000 #000000;">Nombre</th>
                      <th style="width: 30px; background-color: rgba(120,120,120,0.9); font-size:13px; border-style: solid; border-color: #000000 #000000;">Matricula</th>
                      ...
                      <th style="width: 80px; background-color: rgba(120,120,120,0.9); text-align: center; font-size:13px; border-style: solid; border-color: #000000 #000000; border-right: 1px solid black; ">Actividad a realizar</th>
                  </tr>
                  </thead>
          ...
          <td style="font-size:12px; text-align: center; border-style: solid; border-color: #000000 #000000;">{{$act->hora_salida}}</td>
           @foreach($alumnos as $alum)
            @if($alum->matricula==$act->matricula)
               <td style="font-size:12px; text-align: center; border-style: solid; border-color: #000000 #000000;">{{$alum->nombre}} {{$alum->apellidos}}</td>
               <td style="font-size:12px; text-align: center; border-style: solid; border-color: #000000 #000000;">{{$alum->matricula}}</td>
               <td style="font-size:12px; text-align: center; border-style: solid; border-color: #000000 #000000;">{{$alum->carrera}}</td>
