              ...
              <div class="box">
                <div class="box-body">
                  ...
                  <tr style="border:0px; margin-bottom: 6px;">                   
                    <td colspan="3">
                     <h5><div style="text-align: center; margin-top: -20px; margin-bottom: 0px; background-color: rgb(166,166,166);"><b>REPORTE DE DOCENTES<!--BITÁCORA DE ACCESO AL LABORATORIO DE CÓMPUTO SALA B--><br> 
                  ...
                  <tr>
                      <th style="width: 150px; background-color: rgba(120,120,120,0.9); text-align: center; font-size:13px; border-style: solid; border-color: #000000 #000000;">Num. Plaza</th>
                      <th style="width: 200px; background-color: rgba(120,120,120,0.9); font-size:13px; border-style: solid; border-color: #000000 #000000;">Apellidos</th>
                      <th style="width: 150px; background-color: rgba(120,120,120,0.9); text-align: center; font-size:13px; border-style: solid; border-color: #000000 #000000;">Nombre</th>
                  </tr>
                  </thead>
                  <tbody>
    @foreach($docente as $docent)
      <tr>
        <th style="border-style: solid; border-color: #000000 #000000;">{{$docent->n_plaza}}</th>
        <th style="border-style: solid; border-color: #000000 #000000;">{{$docent->apellidos}}</th>
        <th style="border-style: solid; border-color: #000000 #000000;">{{$docent->nombre}}</th> 
      </tr>
    @endForeach
                    </tbody>
