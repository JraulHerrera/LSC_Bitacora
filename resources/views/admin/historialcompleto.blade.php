                ...
                <div class="col-md-12"> 
                                <ul class="nav nav-tabs tabs tabs-top" style="width: 100%;">
                                    <li class="tab active" style="width: 20%;">
                                        <a href="/laboratorio" aria-expanded="true" class="active" id="idadminhistorialcompleto"> 
...
<div class="container">
    ...
    {!!Form::open(['url'=>'/historial/busqueda','method'=>'POST'])!!}
        <!-- ******************************************************************************-->
                                        <div class="row">
                                              <div class="col-md-3">
    ...
    @foreach($historial as $act) 
      <tr>
        ...
        <td>{{ $act->nombrelab }}</td>
        <td class="hidden-xs">{{ $act->equiponame }}</td>
